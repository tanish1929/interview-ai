...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        // Require either resume file OR both descriptions to be filled
        ...
        <div className='home-page'>
            ...
            <div className='interview-card'>
                <div className='interview-card__body'>
                    ...
                    {error && <div style={{ gridColumn: "1 / -1", padding: "1rem", backgroundColor: "#3d1f1f", color: "#ff6b6b", borderRadius: "0.6rem", marginBottom: "1rem" }}>{error}</div>}
